...
# Read secrets from environment variables (set in Railway, NOT in this file)
PLIVO_AUTH_ID = os.getenv('PLIVO_AUTH_ID')
PLIVO_AUTH_TOKEN = os.getenv('PLIVO_AUTH_TOKEN')
PLIVO_PHONE = os.getenv('PLIVO_PHONE')
RECORDED_MESSAGE_URL = os.getenv('RECORDED_MESSAGE_URL', 'https://example.com/message.mp3')
...
def handle_crm_webhook():
    ...
    try:
        ...
        # If audio_url not sent, use default from RECORDED_MESSAGE_URL
...
def test_webhook():
    """
    Simple test endpoint to check Railway + web server.
    """
    data = request.get_json() or {}
    return jsonify({
        'success': True,
